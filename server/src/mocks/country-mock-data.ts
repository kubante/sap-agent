/**
 * Mock country data for Germany when offline
 * This is a realistic response from the REST Countries API for Germany
 */
export const GERMANY_COUNTRY_MOCK_DATA = [
  {
    name: {
      common: "Germany",
    ...
    startOfWeek: "monday",
    capitalInfo: {
      latlng: [52.52, 13.405] as [number, number],
    },
    postalCode: {
      format: "#####",
      regex: "^(\\d{5})$",
